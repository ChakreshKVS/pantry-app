...
import { collection, setDoc, getDocs, updateDoc, deleteDoc, doc, query, where } from "firebase/firestore";
...
export default function Pantry() {
  ...
  const [newItem, setNewItem] = useState<PantryItem>({ id: '', name: '', quantity: 1});
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-2xl font-bold mb-4">Pantry Organizer</h1>
